...
<template>
  <div class="flex-1 flex flex-col min-h-0 bg-white dark:bg-gray-900">
    <!-- 头部 -->
    <div class="flex-shrink-0 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
      <div class="px-6 py-4">
    ...
    <div class="flex-1 flex min-h-0">
      <!-- 侧边栏 -->
      <div class="w-64 flex-shrink-0 bg-gray-50 dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700">
              ...
              <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                ...
                <div class="space-y-2 text-sm">
                  <div class="flex justify-between items-center">
                    ...
                    <kbd class="px-2 py-1 bg-gray-200 dark:bg-gray-700 rounded text-xs font-mono">⌘W / Ctrl+W</kbd>
                  </div>
                  <div class="flex justify-between items-center">
                    <span class="text-gray-700 dark:text-gray-300">切换侧边栏</span>
                    <kbd class="px-2 py-1 bg-gray-200 dark:bg-gray-700 rounded text-xs font-mono">⌘B / Ctrl+B</kbd>
                  </div>
                </div>
              </div>
          ...
          <div class="max-w-2xl">
            ...
            <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 mb-6">
              <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100">{{ appInfo.name }}</h3>
                  <p class="text-gray-600 dark:text-gray-400">{{ appInfo.description }}</p>
                  <p class="text-sm text-gray-500 dark:text-gray-500 mt-1">版本 {{ appInfo.version }}</p>
                </div>
              </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
              ...
              <div class="space-y-3 text-sm">
                <div class="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                  ...
                  <span class="text-gray-900 dark:text-gray-100 font-mono">{{ systemInfo.platform }}</span>
                </div>
                <div class="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                  <span class="text-gray-600 dark:text-gray-400">语言</span>
                  <span class="text-gray-900 dark:text-gray-100 font-mono">{{ systemInfo.language }}</span>
                </div>
                <div class="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                  <span class="text-gray-600 dark:text-gray-400">Electron</span>
                  <span class="text-gray-900 dark:text-gray-100 font-mono">{{ systemInfo.electron }}</span>
                </div>
                <div class="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                  <span class="text-gray-600 dark:text-gray-400">Node.js</span>
                  <span class="text-gray-900 dark:text-gray-100 font-mono">{{ systemInfo.node }}</span>
                </div>
                <div class="flex justify-between items-center py-2">
                  <span class="text-gray-600 dark:text-gray-400">Chrome</span>
                  <span class="text-gray-900 dark:text-gray-100 font-mono">{{ systemInfo.chrome }}</span>
                </div>
              </div>
            </div>
